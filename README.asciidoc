...
[[gradle]]
=== Gradle
https://gradle.org/[Gradle] is the free and open-source build tool developed and maintained by https://develocity.ai/[Develocity],
a for-profit company. (Formerly known as Gradle, Inc.)
